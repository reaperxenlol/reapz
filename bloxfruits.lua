...
print("https://discord.gg/reaperhub")
toclipboard("https://discord.gg/reaperhub")
...
_G.Settings = {
	...
	Fruits = {
		...
		["Select Devil Fruits"] = {}, -- {"Bomb","Spike","Rubber","Spring","Rocket","Spin","Rocket","Spin","Eagle","Smoke","Flame","Ice","Sand","Dark","Diamond","Light","Love","Rubber","Creation","Magma","Portal","Quake","Buddha","Phoenix","Lightning","Pain","Gravity","Dough","Shadow","Venom","Control","Spirit","Dragon"}
